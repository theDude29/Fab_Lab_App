        ...
        return (
            ...
            >
                <View style={styles.main_container}>
                    ...
                    <Text style={styles.default_text}>Les sources du projets sont disponibles sur <A style={styles.lien} href="https://github.com/theDude29/Fab_Lab_App">GitHube.</A></Text>
                    <Text style={styles.default_text}>N'ésitez pas à me contacter à cette adresse: remi.perenne@free.fr</Text>
                    <Text style={styles.default_text}>Allez faire un tour sur <A style={styles.lien} href="http://remi.perenne.free.fr">mon site</A> ;)</Text>
                    <Text style={styles.default_text}>Merci aux sites  <A style={styles.lien} href="https://pixabay.com/fr/">Pixabay</A> et  <A style={styles.lien} href="https://www.flaticon.com/">flaticon</A> pour leurs images et icons qui m'ont permis de rendre cette application plus estétique.</Text>
